...
import { ProfileSchemaForm } from '../../model/types/editableProfileCardSchema';
...
interface EditableProfileInputProps
  ...
  field: keyof Pick<
    ProfileSchemaForm,
    'age' | 'first' | 'lastname' | 'city' | 'username' | 'avatar'
  >;
}

export const EditableProfileInput = (props: EditableProfileInputProps) => {
