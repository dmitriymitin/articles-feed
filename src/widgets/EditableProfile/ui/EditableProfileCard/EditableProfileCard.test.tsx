...
describe('features/EditableProfileCard', () => {
    ...
    test('При отмене значения должны обнуляться', async () => {
        ...
        await userEvent.clear(screen.getByTestId('EditableProfileCardView.lastname'));
        ...
        expect(screen.getByTestId('EditableProfileCardView.first')).toHaveValue('user');
        expect(screen.getByTestId('EditableProfileCardView.lastname')).toHaveValue('user');

        await userEvent.click(
            screen.getByTestId('EditableProfileCardHeader.CancelButton'),
        );

        expect(screen.getByTestId('EditableProfileCardView.first')).toHaveValue(profileTest.first);
        expect(screen.getByTestId('EditableProfileCardView.lastname')).toHaveValue(profileTest.lastname);
    });
